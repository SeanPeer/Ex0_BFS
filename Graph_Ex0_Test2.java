...
public class Graph_Ex0_Test2 {
    ...
    public static void main(String[] args) {
        ...
        s.removeNode(n1.getKey());
        System.out.println(s.getV());
        s.removeNode(n1.getKey());
        System.out.println(s.getV());
        s.connect(n2.getKey(), n3.getKey());
        s.connect(n2.getKey(), n3.getKey());
        System.out.println(n2.getNi());
        s.connect(n2.getKey(), n4.getKey());
        System.out.println(n2.getNi());
        n2.removeNode(n3);
        System.out.println(n2.getNi());
        s.removeEdge(n2.getKey(), n3.getKey());
        System.out.println(s.getV());
        s.removeEdge(n2.getKey(), n3.getKey());
        System.out.println(s.getV());
        s.addNode(n1);
        ...
        graph b = ga.copy();
        System.out.println(s.getV());
     //   System.out.println(s.getMC());
        System.out.println(b.getV());
        System.out.println("graph s: ");
        for (node_data node : s.getV()) {
            System.out.println("s: " + node.getKey());
            System.out.println("s ni: " + node.getNi());
        }
        System.out.println("graph b: ");
        for (node_data node : b.getV()) {
            System.out.println("b: " + node.getKey());
            System.out.println("b ni: " + node.getNi());
        }
      //  System.out.println(b.getMC());
        System.out.println(s.edgeSize());
